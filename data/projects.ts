export const projects = [
  ...
  },
  {
    ...
    year: "2026",
    image: "/InvoiceFlow-images/screencapture-localhost-3001-dashboard-2026-07-22-19_05_47.png",
    gallery: [
      "/InvoiceFlow-images/screencapture-localhost-3001-2026-07-22-18_55_43.png",
      "/InvoiceFlow-images/screencapture-localhost-3001-dashboard-2026-07-22-19_52_56.png",
      "/InvoiceFlow-images/screencapture-localhost-3001-dashboard-invoices-2026-07-22-19_06_02.png",
      "/InvoiceFlow-images/screencapture-localhost-3001-dashboard-invoices-2026-07-22-19_52_03.png",
      "/InvoiceFlow-images/screencapture-localhost-3001-dashboard-invoices-2026-07-22-19_52_18.png",
      "/InvoiceFlow-images/screencapture-localhost-3001-dashboard-customers-2026-07-22-19_06_13.png",
      "/InvoiceFlow-images/screencapture-localhost-3001-dashboard-customers-2026-07-22-19_36_11.png",
      "/InvoiceFlow-images/screencapture-localhost-3001-dashboard-documents-2026-07-22-19_06_31.png",
      "/InvoiceFlow-images/screencapture-localhost-3001-dashboard-documents-2026-07-22-19_35_17.png",
      "/InvoiceFlow-images/screencapture-localhost-3001-dashboard-documents-2026-07-22-19_37_55.png",
      "/InvoiceFlow-images/screencapture-localhost-3001-dashboard-documents-2026-07-22-19_38_13.png",
      "/InvoiceFlow-images/screencapture-localhost-3001-dashboard-products-2026-07-22-19_35_25.png",
      "/InvoiceFlow-images/screencapture-localhost-3001-dashboard-products-edit-d9a3c498-72fb-478d-988a-29af416fd1e0-2026-07-22-19_35_48.png",
      "/InvoiceFlow-images/screencapture-localhost-3001-dashboard-settings-2026-07-22-19_07_07.png",
      "/InvoiceFlow-images/screencapture-localhost-3001-dashboard-settings-2026-07-22-19_07_21.png",
      "/InvoiceFlow-images/screencapture-localhost-3001-dashboard-settings-2026-07-22-19_07_31.png",
      "/InvoiceFlow-images/screencapture-localhost-3001-dashboard-settings-2026-07-22-19_09_01.png",
      "/InvoiceFlow-images/screencapture-localhost-3001-login-2026-07-22-18_56_25.png",
      "/InvoiceFlow-images/screencapture-localhost-3001-register-2026-07-22-18_56_13.png",
      "/InvoiceFlow-images/Capture d'écran 2026-07-22 194335.png",
      "/InvoiceFlow-images/Capture d'écran 2026-07-22 195019.png",
      "/InvoiceFlow-images/Capture d'écran 2026-07-22 195155.png",
      "/InvoiceFlow-images/Capture d'écran 2026-07-22 195245.png",
      "/InvoiceFlow-images/Capture d'écran 2026-07-22 195350.png",
    ],
    description: "InvoiceFlow is a full-stack smart invoicing and financial tracking platform designed to give users complete control over invoice customization, automated calculations, and document management. It allows users to manage clients, products/services, and configure a dynamic tax system. InvoiceFlow integrates Google OAuth2 along with Google Docs and Google Drive APIs, enabling users to import invoice templates directly from Google Docs, perform dynamic variable mapping, select clients and products, and calculate totals automatically before exporting to high-quality PDF or DOCX format. The platform also provides full invoice lifecycle tracking with real-time status updates and key financial performance indicators. Built with Next.js on the frontend, NestJS and PostgreSQL on the backend, and integrated with Google OAuth2, Google Drive, and Google Docs APIs.",
    highlights: [
      "Google Docs integration via Google OAuth2, Drive, and Docs APIs for template imports",
      "Dynamic template variable mapping with automated real-time financial calculations",
      "Export invoices seamlessly to high-resolution PDF or editable DOCX formats",
      "Comprehensive management of clients, product/service catalogs, and dynamic taxes",
      "Full invoice lifecycle tracking with status transitions and key financial indicators",
      "Modern full-stack architecture built with Next.js, NestJS, and PostgreSQL"
    ],
    tech: ["Next.js", "NestJS", "PostgreSQL", "Typescript", "Google OAuth2", "Google Drive API", "Google Docs API", "Tailwind CSS", "PDF Export", "DOCX Export"],
